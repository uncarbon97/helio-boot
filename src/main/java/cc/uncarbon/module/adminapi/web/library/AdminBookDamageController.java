...
public class AdminBookDamageController {
    ...
    @GetMapping(value = "/library/bookDamages")
    ...
    @GetMapping(value = "/library/bookDamages/{id}")
    ...
    @PostMapping(value = "/library/bookDamages")
    ...
    @DeleteMapping(value = "/library/bookDamages")
